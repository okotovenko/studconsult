    ...
    function formSubmit() {
        ...
        async function formSubmitAction(form, e) {
            ...
            if (error === 0) {
                ...
                window.location = "https://studkonsult.com/wp-content/themes/studconsult/thx.html";
            } else {
                e.preventDefault();
                form.classList.remove("_sending");
                window.location = "https://studkonsult.com/wp-content/themes/studconsult/ups.html";
            }
        }
